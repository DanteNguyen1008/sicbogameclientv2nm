 ...
 public void unregisterModifier()
  {
	  ...
	  {
		  scene.patternList.get(getListWinPatter.get(i)).sprite.unregisterEntityModifier(entityModifier);
	  }
			...
			for (int j = 0; j < GameEntity.getInstance().currentGame.winPatterns
				...
				if (scene.patternList.get(i).patternType == GameEntity
					...
					if (isDisplay) {
						...
						scene.patternList.get(i).sprite.registerEntityModifier(entityModifier);
